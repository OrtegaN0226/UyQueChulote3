...
-------------------------------------------------------------------------
@title Large Choices
@author Hime --> HimeWorks (http://himeworks.com) (UPDATED BY JACKHOFFX FOR RPGMAKER MZ)
@version 1.2
@date Jul 17, 2016
...
@target MZ
@plugindesc v1.2 (MV/MZ) - Combines multiple Show Choice commands into one large list.

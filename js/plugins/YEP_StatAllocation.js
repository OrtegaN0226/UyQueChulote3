...
Window_AllocationList.prototype.drawCostAp = function(param, x, y, width) {
  ...
  if (apCost > this._actor.availableAp()) {
    var fmt2 = 'Cost/Available: ' + '\\c[25]%1\\c[0]/%2';
  } else {
    var fmt2 = 'Cost/Available: ' + '%1/%2';
  }
...
//=============================================================================
// Repurpose TP Gauge to Display Allocation Points
//=============================================================================

// Override tp getter for Game_Actor to show available AP instead
Object.defineProperty(Game_Actor.prototype, 'tp', {
    get: function() {
        if (typeof this.availableAp === 'function') {
...
// Override maxTp() for Game_Actor to show total AP instead
Game_Actor.prototype.maxTp = function() {
    if (typeof this.totalAp === 'function') {
        return this.totalAp();
    }
    return 100;
};

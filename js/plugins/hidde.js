...
(function() {
  ...
  //=============================================================================
  // Window_NameBox (VisuMZ / Vanilla compatibility)
  //=============================================================================
  if (typeof Window_NameBox !== "undefined") {
    ...
    Window_NameBox.prototype.update = function() {
      ...
      // Hide or show along with the message window
      if (this._parentWindow) {
        this.visible = this._parentWindow.visible && window.MessageHide_messageWindowVisible;
      } else {

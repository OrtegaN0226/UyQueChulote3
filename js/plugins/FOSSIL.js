...
if(typeof(scriptUrls)!=="undefined")
{
	...
	{
		throw new Error('FOSSIL needs to be the first plugin. If FOSSIL is not the first plugin, everything will break! NOTE: this error is often caused by the usage of JOIplay or similar software that this game is not compatible with. Please retrieve the latest PC or android version and play it natively.'); 
	}
